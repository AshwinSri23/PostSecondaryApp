...
public class Qpanel2 extends JPanel{
	...
	private JLabel question2=new JLabel("Do you prefer Co-op?");//JLabel for displaying question #2 of survey(do you prefer Co-op?)
	...
	private JRadioButton[] cooparray= {yes,no};//Array for storing all the buttons in the panel
	
	
	public Qpanel2() {
		setLayout(null);
		setBounds(720,200,400,100);
