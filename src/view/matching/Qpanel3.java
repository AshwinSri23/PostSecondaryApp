...
public class Qpanel3 extends JPanel{
	...
	private JLabel question3=new JLabel("Do you want to take a supplementary application?");//JLabel for displaying question # of survey(Do you want to take a supplementary application?)
	private JRadioButton yes=new JRadioButton("Yes");//Button for the 1st choice(Yes)
	private JRadioButton no=new JRadioButton("No");//Button for the 2nd choice(No)
	private JRadioButton supparray[]= {yes,no};//Array for storing all the buttons in the panel
	
	
	public Qpanel3() {
		setLayout(null);
		setBounds(720,310,400,100);
