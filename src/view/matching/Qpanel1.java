...
public class Qpanel1 extends JPanel{
	...
	private JLabel question1 = new JLabel("What is your preferred tuition range?"); //JLabel for displaying question #1(What is your preferred tuition range)
	private JRadioButton range1=new JRadioButton("$5,000-$10,000"); //Button for 1st choice($5,000-$15,000)
	private JRadioButton range2=new JRadioButton("$10,000-$15,000"); //Button for 2nd choice($10,000-$15,000)
	private JRadioButton range3=new JRadioButton("$15,000+"); //Button for 3rd choice($15,000+)
	private JRadioButton rangearray[]= {range1,range2,range3}; //Array containing all the buttons in the panel
	
	public Qpanel1(){
		
		setLayout(null);
		setBounds(720,40,400,150);
