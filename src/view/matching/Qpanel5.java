...
public class Qpanel5 extends JPanel{
	...
	private JLabel question5=new JLabel("What field of study do you want to pursue?");//JLabel for displaying question #5 of the survey(What field of study do you want to pursue?)
	private JRadioButton Engineer=new JRadioButton("Engineering");//Button for the 1st choice(Engineering)
	private JRadioButton CS=new JRadioButton("Computer Science");//Button for the 2nd choice(Computer Science)
	private JRadioButton Math=new JRadioButton("Math");//Button for the 3rd choice(Mathematics/Math)
	private JRadioButton subjectarray[]={Engineer,CS,Math};//Array for storing all the buttons in the array
	
	public Qpanel5() {
		setLayout(null);
		setBounds(720,530,400,130);
