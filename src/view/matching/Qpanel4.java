...
public class Qpanel4 extends JPanel{
	...
	private JLabel question4=new JLabel("Do you prefer a part time status?");//JLabel for displaying question #4 of survey(Do you prefer a part-time status?)
	...
	private JRadioButton[] parttimearray={yes,no};//Array for storing all the buttons in the panel
	
	public Qpanel4() {
		setLayout(null);
		setBounds(720,420,400,100);
